        ...
        >
          ...
          >
            <div
              style={{
                ...
                borderImage: 'linear-gradient(180deg, rgba(24, 89, 164, 0.8) 0%, rgba(124, 153, 186, 0.8) 12.98%, rgba(28, 112, 209, 0.8) 42.31%, rgba(30, 124, 232, 0.8) 60.36%, rgba(31, 130, 244, 0.8) 92.79%) 1',
            ...
            <div
              style={{
                ...
                borderRadius: '50%',
                border: '5px solid transparent',
                borderImage: 'linear-gradient(180deg, #1859A4 0%, #1C70D1 28.98%, #7C99BA 49.7%, #1E7CE8 60.36%, #1F82F4 73.09%) 1',
                transform: 'translate(-50%, -50%)',
              }}
            />
            <img
              src="/Company/skillzzaLogo.png"
              alt="Skillzza Logo"
              style={{
                position: 'absolute',
                top: '50%',
            ...
            {[
              {
                icon: '/Company/Partnership EcosystemIcon1.png',
                gradient: 'linear-gradient(180deg, #890404 4.81%, #B01111 52.4%, #E25858 100%)',
                style: { top: '-10px', left: '30px' },
              },
              {
                icon: '/Company/Partnership EcosystemIcon2.png',
                gradient: 'linear-gradient(180deg, #1859A4 0%, #144D8D 35.1%, #1061BD 72.6%, #0D70E1 100%)',
                style: { top: '70px', right: '30px' },
              },
              {
                icon: '/Company/Partnership EcosystemIcon3.png',
                gradient: 'linear-gradient(180deg, #ECCE6B 0%, #F6CB40 50%, #DBB126 100%)',
                style: { bottom: '90px', left: '20px' },
              },
              {
                icon: '/Company/Partnership EcosystemIcon4.png',
                gradient: 'linear-gradient(180deg, #ECCE6B 0%, #F6CB40 50%, #AC4AED 100%)',
          ...
          <div style={{ flex: '1 1 360px', minWidth: '320px' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '18px' }}>
              {[ 'UN Partners', 'Government Collaborations', 'Industry Partners', 'Educational Institutions' ].map((item) => (
                <li key={item} style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                  <span
                    style={{
                      ...
                      height: '20px',
                      borderRadius: '999px',
                      background: 'linear-gradient(180deg, #E25858 0%, #7C3030 100%)',
